...
public class PolylineDecoder {
	...
	public static void main( String[] args) {
		String a="snktI`{rRg@h@^XLPd@tA?DNCVUnByCp@~BdAtDv@`F|CrQv@dFvBpLDVFAvC@lHCjEDd@Bv@h@j@b@zA|@tA^t@HXAd@OdB}@nAi@lAi@hBiAfAw@DYIcCGiBRE|Cg@jAU|Dm@vA[|@Q@R@`ACv@B?DD@TP\\\\VXZNb@BtJ@FH@TC`E@lI|B?bBE|@E|A@BpJ@";
		
		System.out.println(decode(a, 1.0));
