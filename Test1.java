...
public class Test1 extends JFrame {
	...
	public Test1() {
		...
		mapViewer.setBounds(148, 6, 410, 564);
		...
		btnNewButton.setBounds(8, 332, 77, 23);
		contentPane1.add(btnNewButton);
		
		textField = new JTextField();
		textField.setBounds(0, 88, 130, 26);
		contentPane1.add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(0, 139, 130, 26);
		contentPane1.add(textField_1);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField();
		textField_2.setBounds(0, 180, 130, 26);
		contentPane1.add(textField_2);
		textField_2.setColumns(10);
		
		textField_3 = new JTextField();
		textField_3.setBounds(8, 228, 130, 26);
		contentPane1.add(textField_3);
		textField_3.setColumns(10);
		
		textField_4 = new JTextField();
		textField_4.setBounds(6, 266, 130, 26);
